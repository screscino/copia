...
public class Uscita{
	...
	private void initialize() {
		...
		frmProgettoPapaleo.setTitle("USCITA");
		frmProgettoPapaleo.setBounds(100, 100, 801, 300);
		...
		lblUtente.setBounds(53, 89, 755, 64);
		...
		txtUtente.setBounds(37, 153, 725, 95);
		...
		frmProgettoPapaleo.getRootPane().setDefaultButton(btnUscita);
