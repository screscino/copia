...
public class Utente{
	...
	private void initialize() {
		...
		frmProgettoPapaleo.setTitle("Controllo Accessi");
		frmProgettoPapaleo.setBounds(100, 100, 801, 599);
		...
		JLabel lblUtente = new JLabel("Passa il tuo badge e seleziona evento");
